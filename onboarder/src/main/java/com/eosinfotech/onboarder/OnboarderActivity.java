...
import com.eosinfotech.onboarder.views.CircleIndicatorView;
import com.eosinfotech.onboarder.views.FlowingGradientClass;
...
public abstract class OnboarderActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void setOnboardPages(List<OnboarderCard> pages) {

        this.pages = pages;
        onboarderAdapter = new OnboarderAdapter(pages, getSupportFragmentManager(), dpToPixels(0, this), typeface);
        mCardShadowTransformer = new ShadowTransformer(vpOnboarderPager, onboarderAdapter);
